...
r,h,c,w = 360,40,2310,15  # simply hardcoded the values player#6
r1,h1,c1,w1 = 231,20,2281,10  # simply hardcoded the values player#5
r2,h2,c2,w2 = 224,20,2078,10  # simply hardcoded the values player#2
r3,h3,c3,w3 = 312,25,2640,15  # simply hardcoded the values player#9
r4,h4,c4,w4 = 203,20,2352,10  # simply hardcoded the values player#7
...
mask3 = cv2.inRange(hsv_roi3, np.array((0., 180.,130.)), np.array((8.,255.,200.)))#((30., 50.,140.)), np.array((172.,200.,255.)))
mask4 = cv2.inRange(hsv_roi4, np.array((0., 100.,100.)), np.array((18.,200.,200.)))
